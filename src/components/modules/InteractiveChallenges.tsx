...
export function InteractiveChallenges({ moduleId }: { moduleId: string }) {
  ...
  return (
    <div className="space-y-8">
      {/* Header & Score Bar */}
      <div className="flex flex-wrap items-center justify-between gap-4 p-6 rounded-3xl border border-zinc-800 bg-black shadow-xl">
        <div>
        ...
        <div className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-zinc-950 border border-zinc-800 font-mono">
            ...
            >
              ...
              <div className="space-y-2.5 mb-6">
                {ch.options.map((opt) => {
                  ...
                  let optStyle = 'border-zinc-800 bg-zinc-950 hover:bg-zinc-900 hover:border-zinc-700 text-zinc-300';
                  ...
                  return (
                    ...
                    >
                        <span className="flex items-center justify-center w-6 h-6 rounded-lg bg-zinc-800 font-mono text-xs font-bold text-zinc-400 shrink-0 mt-0.5">
                        {opt.id.toUpperCase()}
                      </span>
