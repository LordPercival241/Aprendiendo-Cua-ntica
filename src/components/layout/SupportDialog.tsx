  ...
  return (
    ...
    >
      <section
        ...
        className="relative w-full max-w-md overflow-hidden rounded-2xl border border-zinc-700 bg-zinc-950 text-zinc-100 shadow-2xl"
      >
        <div className="border-b border-zinc-800 px-6 pb-5 pt-6 sm:px-7">
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-300">{t('description')}</p>
        </div>
        ...
        <div className="space-y-4 px-6 py-5 sm:px-7">
          <div className="rounded-xl border border-zinc-800 bg-black p-4 text-center">
            ...
            <div className="mx-auto w-full max-w-[250px] rounded-lg bg-white p-2 shadow-inner">
              <Image
          ...
          <p className="border-l-2 border-cyan-500/70 pl-3 text-xs leading-5 text-zinc-400">{t('impact')}</p>
          <p className="text-center text-[11px] text-zinc-500">{t('voluntary')}</p>
        </div>

        <div className="border-t border-zinc-800 bg-black/40 px-6 py-4 text-center sm:px-7">
          <button
            type="button"
            onClick={onClose}
